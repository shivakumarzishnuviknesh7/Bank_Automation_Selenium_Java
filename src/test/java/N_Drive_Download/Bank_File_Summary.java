...
public class Bank_File_Summary extends Browser_Launch  {

	
	@Test
	public void tc9_Download_File_Bank_Summary() throws IOException, InterruptedException, AWTException {
		 ...
		 * Expected Output - Able to download the generated report from bank file  summary module
		 *
		 */
