...
public class Bank_File  extends Browser_Launch  {
	
	
	
	@Test
	public void tc7_Download_File_Bank_File() throws IOException, InterruptedException, AWTException {
		...
		/*
		 * 
		 * TestCase Type - Positive Expected Output - Able to download the Bank file
		 * based on Bank file configured
		 *
		 */
