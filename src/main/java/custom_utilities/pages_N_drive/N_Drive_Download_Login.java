...
public class N_Drive_Download_Login {
	...
	public N_Drive_Download_Login(WebDriver driver) {
		this.driver = driver;
	}

	public void N_Drive_Login(String message) throws AWTException, InterruptedException {
		...
		if (Run_Environment.equals("Featureuat")) {
			...
			loginPassword = prop.getProperty("passcode_Ndrive");
			loginId = prop.getProperty("id_Ndrive");
			url = prop.getProperty("URL_Ndrive");

		} else if (Run_Environment.equals("Bugfix")) {

			loginPassword = prop.getProperty("passcode_Ndrive_bug_Fix");
			loginId = prop.getProperty("id_Ndrive_bug_Fix");
			url = prop.getProperty("URL_Ndrive_bug_Fix");
